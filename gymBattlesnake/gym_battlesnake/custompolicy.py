...
class CustomPolicy(FeedForwardPolicy):
    ...
    """
    value_fn = None
    proba_distribution, policy, q_value = None, None, None
    def __init__(self, sess, ob_space, ac_space, n_env, n_steps, n_batch, reuse=False, **kwargs):
        ...
        with tf.variable_scope("model", reuse=reuse):
            ...
            CustomPolicy.value_fn = linear(vf_latent, 'vf', 1)
            ...
            CustomPolicy.proba_distribution, CustomPolicy.policy, CustomPolicy.q_value = self.pdtype.proba_distribution_from_latent(pi_latent, vf_latent, init_scale=0.01)

        # self.initial_state = None
        CustomPolicy.initial_state = None
        self._setup_init()