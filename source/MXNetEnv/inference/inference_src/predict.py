...
from source.MXNetEnv.inference.inference_src.battlesnake_heuristics import MyBattlesnakeHeuristics
...
def model_fn(model_dir):
    ...
    model_name = "Model-11x11"
    symbol_name = "{}/local-symbol.json".format(model_dir)#, model_name)
    params_name = "{}/local-0000.params".format(model_dir)#, model_name)
